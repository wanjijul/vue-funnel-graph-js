(function (global, factory) {
    ...
    var __vue_staticRenderFns__ = [];
      ...
      var __vue_inject_styles__ = function (inject) {
        if (!inject) { return }
        inject("data-v-d1f70554_0", { source: ".appear-enter-active[data-v-d1f70554],.appear-leave-active[data-v-d1f70554]{transition:all .7s ease-in-out}.appear-enter-to[data-v-d1f70554],.appear-leave[data-v-d1f70554]{max-width:100%;max-height:100%;opacity:1}.appear-enter[data-v-d1f70554],.appear-leave-to[data-v-d1f70554]{max-width:0;max-height:0;opacity:0}.fade-enter-active[data-v-d1f70554],.fade-leave-active[data-v-d1f70554]{transition:all .3s ease}.fade-enter-to[data-v-d1f70554],.fade-leave[data-v-d1f70554]{opacity:1}.fade-enter[data-v-d1f70554],.fade-leave-to[data-v-d1f70554]{opacity:0}", map: undefined, media: undefined });

      };
      /* scoped */
      var __vue_scope_id__ = "data-v-d1f70554";
      /* module identifier */
