(function (global, factory) {
    ...
    var __vue_staticRenderFns__ = [];
      ...
      var __vue_inject_styles__ = function (inject) {
        if (!inject) { return }
        inject("data-v-1efa5412_0", { source: ".appear-enter-active[data-v-1efa5412],.appear-leave-active[data-v-1efa5412]{transition:all .7s ease-in-out}.appear-enter-to[data-v-1efa5412],.appear-leave[data-v-1efa5412]{max-width:100%;max-height:100%;opacity:1}.appear-enter[data-v-1efa5412],.appear-leave-to[data-v-1efa5412]{max-width:0;max-height:0;opacity:0}.fade-enter-active[data-v-1efa5412],.fade-leave-active[data-v-1efa5412]{transition:all .3s ease}.fade-enter-to[data-v-1efa5412],.fade-leave[data-v-1efa5412]{opacity:1}.fade-enter[data-v-1efa5412],.fade-leave-to[data-v-1efa5412]{opacity:0}", map: undefined, media: undefined });

      };
      /* scoped */
      var __vue_scope_id__ = "data-v-1efa5412";
      /* module identifier */
